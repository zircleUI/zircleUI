      ...
      on: {
        ...
        enter: function enter (el, done) {
          ...
          if (context.parent.$zircleStore.state.mode === 'forward') {
            el.style.animation = 'appear .2s .3s forwards';
            point.style.transformStyle = 'preserve-3d';
            point.style.transform = 'scale3d(' + context.parent.$zircleStore.state.position.scale + ', ' + context.parent.$zircleStore.state.position.scale + ', ' + context.parent.$zircleStore.state.position.scale + ') translate3d(' + context.parent.$zircleStore.state.position.Xi + 'px, ' + context.parent.$zircleStore.state.position.Yi + 'px, 0px)';
